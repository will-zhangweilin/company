...
class upfile {
  ...
  function copyfile($filear) {
    ...
    if (!copy($filear["tmp_name"], $this->savepath.$this->savename)) {
      $errors = array(0 => $lang_upfileOver4, 1 =>
  ...
  function setWidthHeight($width, $height, $maxwidth, $maxheight) {
    ...
    {
	     global $met_img_x,$met_img_y,$met_productimg_x,$lang_upfileFail4,$lang_upfileFail5,$met_thumb_kind;
		if(stristr(PHP_OS,"WIN")){

<?php
 return array (
  ...
  array (
    ...
    'keywords' => '',
    'content' => '<div>
	<img alt="" src="http://localhost:82/jiumu2/upload/images/logo.jpg" style="width: 150px; height: 150px;" />&nbsp; &nbsp;</div>
<div>
	<div>
	...
	<div>
		&nbsp; &nbsp; &nbsp;米拓信息认为诚信是一切合作的基础，宽容是解决问题的前提，创新是发展事业的利器，服务是创造价值的根本。<strong style="line-height: 2;"><span style="font-size: 13px;">关于&ldquo;为合作伙伴创造价值&rdquo;</span></strong></div>
	<div>
		&nbsp; &nbsp; &nbsp;米拓信息认为客户、供应商、公司股东、公司员工等一切和自身有合作关系的单位和个人都是自己的合作伙伴，并只有通过努力为合作伙伴创造价值，才能体现自身的价值并获得发展和成功。</div>
	<div>
		&nbsp;</div>
...
',
  ...
  array (
    ...
    'new_windows' => '',
    'classtype' => '1',
    'out_url' => 'http://localhost:82/jiumu2/admin/',
    'index_num' => '0',
    'access' => '0',
    'indeximg' => '',
    'columnimg' => '',

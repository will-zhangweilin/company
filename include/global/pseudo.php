...
/*url地址*/
	...
	if($cache_column[$listc['bigclass']]['isshow']==0&&$cache_column[$listc['bigclass']]['url']==NULL&&$listc['classtype']!=1){
		...
		if(($listc['classtype']==2||($listc['classtype']==3&&$cache_column[$listc['bigclass']]['releclass']))&&$listc['foldername']==$cache_column[$listc['bigclass']]['foldername']&&$langnums==1){	
			$cache_column[$listc['bigclass']]['url']=$urltop;
		}	
	}
	next($cache_column);	
}
